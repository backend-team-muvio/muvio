...
public class SyncSchedulerServiceImpl implements SyncSchedulerService {
    ...
    public void start() {
        ...
        mediaSyncService.importMedia(LANGUAGE, REGION, currentYear, imdbTop250Movies,
                oscarWinningMovies, actorStorage, mediaStorage, true);
        mediaSyncService.importMedia(LANGUAGE, REGION, currentYear, imdbTop250TvShows,
    ...
    public void worker() {
        ...
        mediaSyncService.importMedia(LANGUAGE, REGION, currentYear, imdbTop250TvShows,
                emmyWinningTvShows, actorStorage, mediaStorage, false);
        mediaSyncService.importByFindingTitles(LANGUAGE, REGION, currentYear, actorStorage,
                mediaStorage, imdbTop250Movies, oscarWinningMovies, true);
        mediaSyncService.importByFindingTitles(LANGUAGE, REGION, currentYear, actorStorage,
                mediaStorage, imdbTop250TvShows, emmyWinningTvShows, false);
        mediaSyncService.importMediaByFilter(LANGUAGE, currentYear, imdbTop250Movies,
                oscarWinningMovies, mediaStorage, actorStorage, true);
        mediaSyncService.importMediaByFilter(LANGUAGE, currentYear, imdbTop250TvShows,
